...
RSpec.describe BuyersController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all buyers as @buyers" do
      ...
      expect(assigns(:buyers)).to eq([buyer])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created buyer as @buyer" do
        post :create, {:buyer => valid_attributes}, valid_session
        expect(assigns(:buyer)).to be_a(Buyer)
        expect(assigns(:buyer)).to be_persisted
      end

      it "redirects to the created buyer" do
        post :create, {:buyer => valid_attributes}, valid_session
        expect(response).to redirect_to(Buyer.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved buyer as @buyer" do
        post :create, {:buyer => invalid_attributes}, valid_session
        expect(assigns(:buyer)).to be_a_new(Buyer)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested buyer" do
        buyer = Buyer.create! valid_attributes
        put :update, {:id => buyer.to_param, :buyer => new_attributes}, valid_session
        buyer.reload
    ...
    context "with invalid params" do
      it "assigns the buyer as @buyer" do
        buyer = Buyer.create! valid_attributes
        put :update, {:id => buyer.to_param, :buyer => invalid_attributes}, valid_session
        expect(assigns(:buyer)).to eq(buyer)
      end
